      ...
      <div class="download-app-wrap">
        @if(@$getinfo->ios != "")
          <div class="download-app-icon">
            <a href="{{@$getinfo->ios}}" target="_blank"><img src="{!! asset('storage/app/public/front/images/apple-store.svg') !!}" alt=""></a>
          </div>
        @endif

        @if(@$getinfo->android != "")
          <div class="download-app-icon">
            <a href="{{@$getinfo->android}}" target="_blank"><img src="{!! asset('storage/app/public/front/images/play-store.png') !!}" alt=""></a>
          </div>
        @endif
      </div>
    </div>
