...
return [
    ...
    */
    ...
    "free_addons" => "Add-ons",
    "paid_addons" => "Add-ons",
    "add_to_cart" => "Pesan Makanan",
    "my_cart" => "KERANJANG SAYA",
    "apply" => "GUNAKAN",
    "select_promocode" => "Pilih Kode Promo",
    "copy" => "PILIH",
    "code" => "Kode",
    "payment_summary" => "Pembayaran",
    "payment_summary1" => "PEMBAYARAN",
    "order_total" => "Subtotal",
    "tax" => "Pajak",
    "delivery_charge" => "Biaya Antar",
    "total_amount" => "Total Bayar",
    "delivery" => "Delivery",
    "pickup" => "Antar ke Meja",
    "cash_payment" => "Pesan Sekarang",
    "wallet_payment" => "Wallet Payment",
    "razorpay_payment" => "Razorpay Payment",
    "stripe_payment" => "Stripe Payment",
    "view_my_order" => "Pesanan Saya",
    ...
    "order_delivered" => "Pesanan Diantar",
    "cancel_by_admin" => "Canceled by Adm",
    "cancel_by_user" => "Canceled by You",
    ...
    "sale_price" => "Harga penjualan (jika ada)",
