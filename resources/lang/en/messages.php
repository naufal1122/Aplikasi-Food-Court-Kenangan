...
return [
    ...
    */
    ...
    "select_pincode" => "Pilih kode pos",
    "select_timezone" => "Pilih zona waktu",
    "select_driver" => "Pick driver",
    "select_category" => "Pilih kategori",
    "select_type" => "Pilih jenis",
    "select_item" => "Pilih item",
    "select_ingredients" => "Pilih bahan",
    "select_addons" => "Pilih Add-ons",
    ...
    "enter_tax" => "Input pajak dalam persentase (%)",
    ...
    "enter_category" => "Masukkan Kategori",
    "enter_item_name" => "Masukkan nama menu",
    "enter_price" => "Masukkan harga",
    "enter_product_price" => "Masukkan harga produk",
    "enter_sale_price" => "Masukkan harga jual (jika ada)",
    "enter_delivery_time" => "Masukkan waktu pengiriman (dalam menit)",
    "enter_addons_name" => "Masukkan nama add-ons",
    "enter_pincode" => "Enter Pincode for available delivery",
    "enter_offer_name" => "Masukkan nama promo",
    "enter_offer_code" => "Masukkan kode promo",
    "enter_offer_percentage" => "Masukkan promo dalam persentase (%)",
    "enter_offer_description" => "Masukkan deskripsi promo",
    "enter_driver_name" => "Enter driver name",
    "enter_title" => "Masukkan judul",
    "enter_amount" => "Masukkan jumlah",
    "enter_variation" => "Masukkan variasi",
    "select_variation" => "Pilih Variasi",

    //Admin
    "enter_slider_title" => "Masukkan judul slider",
